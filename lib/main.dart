...
import 'package:fesenko_pmp_laba_1/weather.dart';
import 'package:fesenko_pmp_laba_1/weather_detail.dart';
import 'package:flutter/material.dart';
import 'package:fesenko_pmp_laba_1/person.dart';
import 'details.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final persons = <Person>[
    ...
    Person("Anton Fesenko", "Student SCSm-23-1"),
  ];
  ...
  void initState() {
    ...
    weatherInfo = fetchWeather("Kharkiv");
